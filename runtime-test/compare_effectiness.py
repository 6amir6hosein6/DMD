...
def compare_lsar_and_loop_overhead():
    ...
    configs = [
        ('runtime/execution_times_b1_w1.csv', 1, 1),
        ('runtime/execution_times_b2_w2.csv', 2, 2),
        ('runtime/execution_times_b2_w4.csv', 2, 4),
        ('runtime/execution_times_b4_w4.csv', 4, 4),
    ]
    ...
    # Save the plot
    plt.savefig('runtime/comparison_plot2.png', bbox_inches='tight')
    plt.close()
